...
public class MainActivity extends AppCompatActivity implements NoteListAdapter.OnDeleteClickListener {
    ...
    private String TAG = "XXXMainActivity";
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == NEW_NOTE_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK){
            ...
            Log.d(TAG, "id : " +note_id+ " | Note :" + data.getStringExtra(NewNoteActivity.NOTE_ADDED) );
            ...
            Toast.makeText(getApplicationContext(),"Unable to save Note",Toast.LENGTH_LONG).show();
        }
    }
